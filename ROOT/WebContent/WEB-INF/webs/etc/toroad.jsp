				...
				<div id="visualarea">
					<div id="realcontents">
						<div class="realcon">
							...
							<script type="text/javascript">
								var oPoint = new nhn.api.map.LatLng(37.5114233,
										127.0533457);
								var defaultLevel = 11;
						...
						<div class="address">
							<div class="row">
								...
								<address>
									<strong>주소</strong><br> 서울시 강남구 삼성로 107길 7, 201(삼성동, 보아스
									빌딩)<br> 201, 7 Samseong-ro 107-gilmGangna-gu, Seoul, Korea
								</address>
								...
								<address>
									<strong>버스</strong><br> 2호선 삼성역 5번출구 앞 정류장에서 마을 버스 강남 07번,
									08번과 지선 버스 3411번 이용 '한별 구립 어린이집' 정류장에서 하차
								</address>
