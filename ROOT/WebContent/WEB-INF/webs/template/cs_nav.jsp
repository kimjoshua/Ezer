...
#dMenu .introB a#btn2depth span { left: 140px;}
</style>
<div id="header">
		...
		<div class="introB " style="width: 200px;">
			...
			<ul class="">
				<li class=" dropdown-submenu" style="top: 13px;"><a href="#"
					...
					id="btn2depth" class="hover"> 고객 센터 <span class=""
						>메뉴 목록 닫기</span></a>
...
case 'notice':
	$('.introB').append("<span style='position: inherit;left: 152px;cursor:pointer;float: left;' class='toggl'>공지 사항</span>");
	break;
case 'qa':
	$('.introB').append("<span style='position: inherit;left: 152px;cursor:pointer;float: left;' class='toggl'>문의 </span>");
	break;
