...
<link rel="shortcut icon" href="/imag/withtest.png">
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner" role="listbox">
								<div class="item">
									...
									<map name="maptag1">
										<area shape="rect" coords="x50,y245,x200,y290" href="/introBrand" title="">
									</map>
								</div>
								...
								<div class="item">
									...
									<map name="maptag3">
										<area shape="rect" coords="x50,y245,x200,y290" href="/cygneWrink" title="">
									</map>
								</div>
							</div>
							</div>
									...
									<div class="img1 parbase image">
										<div class="article">
											...
											<div class="figure tCenter">
												<ul class="visual">
													<li><span class="hover"><a href="" title="에제르코스메틱"></a></span></li>
												</ul>
											</div>
										</div>
									</div>
								...
								<div class="cell">
									<div class="img2 parbase image">
										<div class="article">
											...
											<div class="figure tCenter">
												<ul class="visual">
													<li><span class="hover"><a href="" title="브랜드소개 자세히 보기"></a></span></li>
												</ul>
											</div>
										</div>
									</div>
								...
								<div class="cell">
									<div class="parbase image img3">
										...
										<div class="article">
											...
											<div class="figure tCenter">
												<ul class="visual">
													<li><span class="hover"><a href="" title="제품 소개 자세히 보기"></a></span></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<div class="article">
								...
								<div class="text">
									<a href="/ad" onclick="" title="뉴스  미디어 자세히 보기"> 에제르코스메틱과 각
										브랜드 및 제품에 관한<br> <br> 최신 소식을 알려드립니다.
									</a>
								</div>
							</div>
						</div>
					...
					<ul class="quickmenu mobileVary">
						...
						<li>
							<dl>
								...
								<dd>
									<a href="http:" "www.color_ex.com"="" onclick="trackClicksEx('푸터 브랜드|글로벌 챔피언 브랜드')">COLOR
										EZ</a>
								</dd>
								<dd>
						...
						<li>
							<dl>
								...
								<dd>
									<a href="/bioatox" onclick="trackClicksEx('푸터 Supply Chain Management|생산물류사업장(SCM)')">BIOSELEMIX</a>
									<ul>
						...
						<li class="bar">
							<dl>
								...
								<dd class="desktop">
									<a href="/toroad" class="blt-balloon fcLblack" onclick="trackClicksEx('푸터 매장찾기')"><strong>찾아오시는
											길</strong></a>
								</dd>
								<dd class="/mobile store fDepth">
									<a href="/service" onclick="trackClicksEx('푸터 매장찾기')" class="blt-balloon toggleTrigger"><strong>서비스이용약관</strong></a>
								</dd>
								<dd class="mobile store fDepth">
									<a href="/personal" onclick="trackClicksEx('푸터 매장찾기')" class="blt-balloon toggleTrigger"><strong>개인정보
											취급방침</strong></a>
								</dd>
								<dd class="mobile store fDepth">
									<a href="/change" onclick="trackClicksEx('푸터 매장찾기')" class="blt-balloon toggleTrigger"><strong>교환 및 환불</strong></a>
								</dd>
								<dd class="mobile store fDepth">
									<a href="/costom" onclick="trackClicksEx('푸터 매장찾기')" class="blt-balloon toggleTrigger"><strong>소비자 상담실</strong></a>
								</dd>
								<dd class="mobile store fDepth">
									<a href="toroad" onclick="trackClicksEx('푸터 매장찾기')" class="blt-balloon toggleTrigger"><strong>찾아오시는 길</strong></a>
								</dd>
								<dd>
									<div class="familysite">
										<a href="/site" onclick="trackClicksEx('푸터 관련 사이트')" class="btnFamily"><span>FAMILY SITE</span></a>
									</div>
								</dd>
							</dl>
